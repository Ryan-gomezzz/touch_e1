...
const styles = StyleSheet.create({
  ...
  calendarLoading: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: '#FFF', borderRadius: 14, padding: 16 },
  calendarLoadingText: { fontSize: 14, color: '#636E72' },
  calendarCard: { backgroundColor: '#FFF', borderRadius: 14, padding: 16, gap: 12, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.03, shadowRadius: 8, elevation: 1 },
  calendarSlot: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  calendarSlotIcon: { width: 32, height: 32, borderRadius: 16, backgroundColor: '#D8F3DC', justifyContent: 'center', alignItems: 'center' },
  calendarSlotInfo: { flex: 1 },
  calendarSlotDay: { fontSize: 15, fontWeight: '600', color: '#2D3436' },
  calendarSlotReason: { fontSize: 13, color: '#636E72', marginTop: 2 },
  calendarTip: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: '#A8DADC20', borderRadius: 10, padding: 12, marginTop: 4 },
  calendarTipText: { fontSize: 13, color: '#457B9D', flex: 1, lineHeight: 19 },
});
